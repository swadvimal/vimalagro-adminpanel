...
function ProductPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (files.productBanner)
        formData.append("productBanner", files.productBanner);
      if (files.productBannerMobile)
        formData.append("productBannerMobile", files.productBannerMobile); // ✅
      if (files.banner2) formData.append("banner2", files.banner2);
      if (files.banner2Mobile)
        formData.append("banner2Mobile", files.banner2Mobile); // ✅
      if (files.howToMakeBanner)
        formData.append("howToMakeBanner", files.howToMakeBanner);
      if (files.howToMakeBannerMobile)
        formData.append("howToMakeBannerMobile", files.howToMakeBannerMobile); // ✅
      ...
      if (editingProductId) {
        ...
        await axios.post("https://vimalagro-backend.onrender.com/api/products/add", formData, {
          headers: { "Content-Type": "multipart/form-data" },
        });
      ...
      if (productBannerMobileRef.current)
        productBannerMobileRef.current.value = ""; // ✅
      ...
      if (howToMakeBannerMobileRef.current)
        howToMakeBannerMobileRef.current.value = ""; // ✅
    } catch (err) {
      console.error(err);
        ...
        <div className="rounded-3 shadow overflow-hidden">
          ...
          <div className="px-4 pb-4 pt-2 bg-white">
            ...
            <div className="d-lg-flex d-md-flex gap-3">
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Product Banner(horizontally Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                ...
                {(files.productBanner || product.productBanner) &&
                  !loadingImages.productBanner && (
                    <div className="mt-2">
                      <img
                        src={
                          files.productBanner
              ...
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Product Banner-Mobile (Vertically Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                ...
                />
                {loadingImages.productBannerMobile && (
                  <div>Loading image...</div>
                )}
                {(files.productBannerMobile || product.productBannerMobile) &&
                  !loadingImages.productBannerMobile && (
                    <div className="mt-2">
                      <img
                        src={
            ...
            <div className="d-lg-flex d-md-flex gap-3">
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Banner 2(horizontally Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                ...
                {(files.banner2 || product.banner2) &&
                  !loadingImages.banner2 && (
                    <div className="mt-2">
                      <img
                        src={
                          files.banner2
                            ? URL.createObjectURL(files.banner2)
                            : product.banner2
                        }
                        alt="Banner 2"
                        className="object-fit-fill"
              ...
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Banner2-Mobile (Vertically Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                ...
                />
                {(files.banner2Mobile || product.banner2Mobile) &&
                  !loadingImages.banner2Mobile && (
                    <div className="mt-2">
                      <img
                        src={
                          files.banner2Mobile
                            ? URL.createObjectURL(files.banner2Mobile)
            ...
            <div className="d-lg-flex d-md-flex gap-3">
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  How To Make Banner(horizontally Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                ...
                {(files.howToMakeBanner || product.howToMakeBanner) &&
                  !loadingImages.howToMakeBanner && (
                    <div className="mt-2">
                      <img
                        src={
              ...
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  How To Make Banner-Mobile (Vertically Rectangle)
                </label>
                <input
                  type="file"
                  className="mt-1 w-100 form-control border border-secondary"
                  ...
                  disabled={
                    formSubmitting || loadingImages.howToMakeBannerMobile
                  }
                />
                {(files.howToMakeBannerMobile ||
                  product.howToMakeBannerMobile) &&
                  !loadingImages.howToMakeBannerMobile && (
                    <div className="mt-2">
                      <img
                        src={
                          files.howToMakeBannerMobile
                            ? URL.createObjectURL(files.howToMakeBannerMobile)
                            : product.howToMakeBannerMobile
                        }
            ...
            <div className="d-lg-flex d-md-flex gap-3">
              ...
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                ...
                <input
                  ...
                  value={sub.weight}
                  onChange={handleSubChange}
                  className={`text-uppercase mt-1 w-100 form-control border ${
            ...
            <div className="w-100 w-lg-50 w-md-50 mt-2">
              ...
              {sub.subproductImg && !loadingImages.subproductImg && (
                <div className="mt-2">
                  <img
                    src={
                      sub.subproductImg instanceof File
                        ? URL.createObjectURL(sub.subproductImg)
                        : sub.subproductImg
                    }
                    alt="Subproduct"
                    className="object-fit-fill"
        ...
        <div className="rounded-3 shadow overflow-hidden mt-4">
          ...
          <div className="px-4 pb-4 pt-2 bg-white">
            ...
            <div className="d-lg-flex d-md-flex gap-3">
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Main Recipe Image(Square Shape Required)
                </label>
                <input
                  type="file"
              ...
              <div className="w-100 w-lg-50 w-md-50 mt-2">
                <label className="d-block fw-bold">
                  Sub Recipe Image(Square Shape Required)
                </label>
                <input
                  type="file"
                  ref={recipeSubImgRef}
                ...
                {Array.isArray(recipe.recipeSubImg) &&
                  recipe.recipeSubImg.length > 0 &&
                  !loadingImages.recipeSubImg && (
                          ...
                          <td style={{ width: "20%" }}>
                            {r.recipeMainImg &&
                              (r.recipeMainImg instanceof File ? (
                                <img
                                  src={URL.createObjectURL(r.recipeMainImg)}
                                  alt="Main Img"
                                  width="50"
                                />
                              ) : (
                          ...
                          <td style={{ width: "20%" }}>
                            {Array.isArray(r.recipeSubImg)
                              ...
                              : r.recipeSubImg && (
                                  <img
                                    src={
                                      r.recipeSubImg instanceof File
                                        ? URL.createObjectURL(r.recipeSubImg)
                                        : r.recipeSubImg
                                    }
                                    alt="Sub Img"
                                    width="50"
            ...
            <table className="table table-bordered border-secondary custom-table table-hover text-center">
              <thead style={{ fontSize: "15px" }}>
                <tr>
                  ...
                  <th
                    className="text-white"
                    style={{ width: "50%", background: "var(--red)" }}
                  >
                    Product Size
                  </th>
                  <th
                ...
                {products.length > 0 ? (
                  products.map((p) => (
                    <tr key={p._id}>
                      <td style={{ width: "20%" }}>
                        {p.productBanner && (
                          <img src={p.productBanner} alt="" width="60" />
                        )}
                      </td>
                      ...
                      <td style={{ width: "50%" }}>{p.displayOrder}</td>
                      <td style={{ width: "10%" }}>
                        <div className="d-flex flex-column flex-md-row flex-lg-row justify-content-center align-items-center">
                          <FaEdit
                            className="text-warning fs-5 me-0 me-md-2 mb-2 mb-md-0"
