...
function BlogBanner() {
    ...
    const [currentImages, setCurrentImages] = useState({ desktopblogbanner: "", mobileblogbanner: "" });

    const desktopInputRef = useRef(null);
    const mobileInputRef = useRef(null);

    const API_URL = "https://vimalagro-backend.onrender.com/blogbanner";
    ...
    const handleSubmit = async (e) => {
        ...
        if (desktopBanner) formData.append("desktopblogbanner", desktopBanner);
        if (mobileBanner) formData.append("mobileblogbanner", mobileBanner);
    ...
    const handleEdit = (item) => {
        ...
        setMobileBanner(null);
        setCurrentImages({
            desktopblogbanner: item.desktopblogbanner,
            mobileblogbanner: item.mobileblogbanner,
        });
    ...
    return (
        <div className="container mt-3 mt-lg-0 mt-md-0">
            <h3 className="fw-bold text-center mb-3 mb-md-4 main-tittle">Blog Banner</h3>
                ...
                <div className="rounded-3 shadow overflow-hidden">
                    ...
                    >
                        <h6 className="fw-bold m-0 text-dark">
                            <FaPlus className="me-2" /> {editId ? "Edit Blog Banner" : "Add Blog Banner"}
                        </h6>
                    </div>
                    <div className="px-4 pb-4 pt-2 bg-white">
                        <div className="d-lg-flex d-md-flex gap-3">
                            ...
                            <div className="w-100 w-lg-50 w-md-50 mt-2">
                                ...
                                <input
                                    type="file"
                                    name="mobileblogbanner"
                                    accept="image/*"
                                    className="mt-1 w-100 form-control border border-secondary"
                                    onChange={(e) => {
                                        setMobileBanner(e.target.files[0]);
                                        setCurrentImages(prev => ({ ...prev, mobileblogbanner: "" })); // Clear old path
                                    }}
                                    ref={mobileInputRef}
                                    disabled={isDisabled}
                                />
                                {editId && currentImages.mobileblogbanner && (
                                    <div className="mt-1 text-secondary" style={{ fontSize: "12px", whiteSpace: "normal", wordBreak: "break-all" }}>
                                        {currentImages.mobileblogbanner}
                                    </div>
                                )}
                            </div>
                        </div>
