...
function HomeBanner() {
    ...
    const [currentImages, setCurrentImages] = useState({ desktophomebanner: "", mobilehomebanner: "" });

    const desktopInputRef = useRef(null);
    const mobileInputRef = useRef(null);

    const API_URL = "https://vimalagro-backend.onrender.com/homebanner";
    ...
    const handleSubmit = async (e) => {
        ...
        if (desktopBanner) formData.append("desktophomebanner", desktopBanner);
        if (mobileBanner) formData.append("mobilehomebanner", mobileBanner);
    ...
    const handleEdit = (item) => {
        ...
        setMobileBanner(null);
        setCurrentImages({
            desktophomebanner: item.desktophomebanner,
            mobilehomebanner: item.mobilehomebanner,
        });
    ...
    return (
        <div className="container mt-3 mt-lg-0 mt-md-0">
            <h3 className="fw-bold text-center mb-3 mb-md-4 main-tittle">Home Banner</h3>
                ...
                <div className="rounded-3 shadow overflow-hidden">
                    ...
                    >
                        <h6 className="fw-bold m-0 text-dark">
                            <FaPlus className="me-2" /> {editId ? "Edit Home Banner" : "Add Home Banner"}
                        </h6>
                    </div>
                            ...
                            <div className="w-100 w-lg-50 w-md-50 mt-2">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setCurrentImages(prev => ({ ...prev, mobilehomebanner: "" })); // Clear old path
                                    }}
                                    ref={mobileInputRef}
                                    disabled={isDisabled}
                                />
                                {editId && currentImages.mobilehomebanner && (
                                    <div className="mt-1 text-secondary" style={{ fontSize: "12px", whiteSpace: "normal", wordBreak: "break-all" }}>
                                        {currentImages.mobilehomebanner}
                                    </div>
                                )}
                            </div>
                        </div>
